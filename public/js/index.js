...
$h2.innerText += ` ${userName.trim()}`;  /* trim -> saca los espacios vacios */
...
background && $body.classList.add('fondo'); /* Agarra el body, entra a la propiedad del body que se llama classList y le agrega con add una nueva clase que se llama fondo */
/* element.classList.remove.toggle('fondo') Sacariamos la clase con remove con add agregamos y con toggle: agregamos o quitamos dependiendo de como este */
